...
def nr_reader(*args):
   nr_list = list(input("Enter a double digit number"))#we convert list for indexing given number
   ...
   print(onluk[x],birlik[y],sep="") #calling values for each digit to print,adjacent values due to empty separator
nr_reader()